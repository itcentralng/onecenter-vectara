...
class Partner(db.Model):
    ...
    corpus_id = db.Column(db.String, unique=True)
    ...
    def update(self, name=None, category=None, description=None, email=None, phone=None, address=None, logo=None, website=None, corpus_id=None):
        ...
        self.corpus_id = corpus_id or self.corpus_id
